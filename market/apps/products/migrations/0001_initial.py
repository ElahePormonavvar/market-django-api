    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summery_description', models.TextField(blank=True, default='', null=True, verbose_name='توضیحات مختصر')),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, verbose_name='توضیحات کامل')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('features', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.feature', verbose_name='ویژگی')),
                ('filter_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='filter_feature_value', to='products.featurevalue', verbose_name='مقدار ویژگی فیلتر')),
                ('products', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_features', to='products.product', verbose_name='کالا')),
            ],
            options={
