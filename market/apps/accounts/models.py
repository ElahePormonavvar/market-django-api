...
class CustomUser(AbstractBaseUser,PermissionsMixin):
    ...
    user_permissions = models.ManyToManyField('auth.Permission',verbose_name='user permissions',blank=True,related_name='customuser_permissions')
    last_login = models.DateTimeField(null=True, blank=True)  # اضافه کردن فیلد آخرین ورود
